...
这是一个基于三星官方内核源码构建的，适用于 **三星 Galaxy S24 系列** 的高性能自定义内核。它旨在提供卓越的稳定性和流畅度，同时集成了最新的 KernelSU 功能，为您带来最佳的玩机体验。
...
* **版本信息**: `-android14-Kokuban-Elysia-BYEC`
...
# Kokuban Kernel for Samsung Galaxy S24 Series
...
This is a high-performance custom kernel for the **Samsung Galaxy S24 Series**, built upon Samsung's official kernel source. It is designed to deliver exceptional stability and smoothness while integrating the latest KernelSU features for the ultimate user experience.
...
* **Version Info**: `-android14-Kokuban-Elysia-BYEC`
